...
#ifndef SamiRouteList_H_
#define SamiRouteList_H_
...
class SamiRouteList: public SamiObject {
public:
    SamiRouteList();
    SamiRouteList(String* json);
    virtual ~SamiRouteList();
    ...
    SamiRouteList* fromJson(String* obj);
