...
public:
    ...
    QString* getOperatorreference();
    void setOperatorreference(QString* operatorreference);
QString* getOperatorname();
    void setOperatorname(QString* operatorname);
QString* getOperatordescription();
    void setOperatordescription(QString* operatordescription);

private:
    QString* operatorreference;
