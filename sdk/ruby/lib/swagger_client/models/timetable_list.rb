  ...
  class TimetableList
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'errorcode')
        self.errorcode = attributes[:'errorcode']
      end

      if attributes.has_key?(:'errormessage')
        self.errormessage = attributes[:'errormessage']
      end

      if attributes.has_key?(:'numberofresults')
        self.numberofresults = attributes[:'numberofresults']
      end
    ...
    def hash
      [errorcode, errormessage, numberofresults, route, stopid, timestamp, results].hash
    end
