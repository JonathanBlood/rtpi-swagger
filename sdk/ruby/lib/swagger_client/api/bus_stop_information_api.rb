...
module SwaggerClient
  class BusStopInformationApi
    ...
    # @option opts [String] :stopid The bus stop id, if not provided all bus stops are returned
    # @option opts [String] :stopname The stop name, only matching stops are returned
    # @return [BusStopList]
    def get_bus_stops(opts = {})
    ...
    # @option opts [String] :stopid The bus stop id, if not provided all bus stops are returned
    # @option opts [String] :stopname The stop name, only matching stops are returned
    # @return [Array<(BusStopList, Fixnum, Hash)>] BusStopList data, response status code and response headers
    def get_bus_stops_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: BusStopInformationApi.get_bus_stops ..."
      end
      ...
      # resource path
      local_var_path = "/busstopinformation".sub('{format}','json')

      # query parameters
      query_params = {}
      query_params[:'format'] = opts[:'format'] if !opts[:'format'].nil?
      query_params[:'operator'] = opts[:'operator'] if !opts[:'operator'].nil?
      query_params[:'stopid'] = opts[:'stopid'] if !opts[:'stopid'].nil?
      query_params[:'stopname'] = opts[:'stopname'] if !opts[:'stopname'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'BusStopList')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BusStopInformationApi#get_bus_stops\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
