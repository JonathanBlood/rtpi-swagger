...
# Unit tests for SwaggerClient::RealTimeBusInformationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RealTimeBusInformationApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RealTimeBusInformationApi.new
  end
  ...
  describe 'test an instance of RealTimeBusInformationApi' do
    it 'should create an instact of RealTimeBusInformationApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RealTimeBusInformationApi)
    end
  end

  # unit tests for get_real_time_bus_information
  ...
  describe 'get_real_time_bus_information test' do
    it "should work" do
