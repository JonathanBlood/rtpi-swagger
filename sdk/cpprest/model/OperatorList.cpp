...
void OperatorList::validate() 
{
    // TODO: implement validation
}

web::json::value OperatorList::toJson() const
{
...
void OperatorList::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[U("results")].as_array() )
        {
            ...
            if(item.is_null()) 
            {
                m_Results.push_back( std::shared_ptr<Operator>(nullptr) );
            }
            else
            {
...
void OperatorList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OperatorList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
	if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
	{
...
utility::string_t OperatorList::getErrorcode() const
{
	return m_Errorcode;
}
void OperatorList::setErrorcode(utility::string_t value)
{
	m_Errorcode = value;
    m_ErrorcodeIsSet = true;
}
bool OperatorList::errorcodeIsSet() const
{
    return m_ErrorcodeIsSet;
}
void OperatorList::unsetErrorcode() 
{
    m_ErrorcodeIsSet = false;
}
utility::string_t OperatorList::getErrormessage() const
{
	return m_Errormessage;
}
void OperatorList::setErrormessage(utility::string_t value)
{
	m_Errormessage = value;
    m_ErrormessageIsSet = true;
}
bool OperatorList::errormessageIsSet() const
{
    return m_ErrormessageIsSet;
}
void OperatorList::unsetErrormessage() 
{
    m_ErrormessageIsSet = false;
}
int32_t OperatorList::getNumberofresults() const
{
	return m_Numberofresults;
}
void OperatorList::setNumberofresults(int32_t value)
{
	m_Numberofresults = value;
    m_NumberofresultsIsSet = true;
}
bool OperatorList::numberofresultsIsSet() const
{
    return m_NumberofresultsIsSet;
}
void OperatorList::unsetNumberofresults() 
{
    m_NumberofresultsIsSet = false;
}
utility::string_t OperatorList::getTimestamp() const
{
	return m_Timestamp;
}
void OperatorList::setTimestamp(utility::string_t value)
{
	m_Timestamp = value;
    m_TimestampIsSet = true;
}
bool OperatorList::timestampIsSet() const
{
    return m_TimestampIsSet;
}
void OperatorList::unsetTimestamp() 
{
    m_TimestampIsSet = false;
}
std::vector<std::shared_ptr<Operator>>& OperatorList::getResults()
{
	return m_Results;
}
bool OperatorList::resultsIsSet() const
{
    return m_ResultsIsSet;
}
void OperatorList::unsetResults() 
{
    m_ResultsIsSet = false;
}
