...
#ifndef RouteDetailList_H_
#define RouteDetailList_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<RouteDetail>>& getResults();
...
std::vector<std::shared_ptr<RouteDetail>> m_Results;
    bool m_ResultsIsSet;
};
