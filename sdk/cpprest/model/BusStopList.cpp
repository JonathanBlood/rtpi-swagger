...
void BusStopList::validate() 
{
    // TODO: implement validation
}

web::json::value BusStopList::toJson() const
{
...
void BusStopList::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[U("results")].as_array() )
        {
            ...
            if(item.is_null()) 
            {
                m_Results.push_back( std::shared_ptr<Stop>(nullptr) );
            }
            else
            {
...
void BusStopList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void BusStopList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
	if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
	{
...
utility::string_t BusStopList::getErrorcode() const
{
	return m_Errorcode;
}
void BusStopList::setErrorcode(utility::string_t value)
{
	m_Errorcode = value;
    m_ErrorcodeIsSet = true;
}
bool BusStopList::errorcodeIsSet() const
{
    return m_ErrorcodeIsSet;
}
void BusStopList::unsetErrorcode() 
{
    m_ErrorcodeIsSet = false;
}
utility::string_t BusStopList::getErrormessage() const
{
	return m_Errormessage;
}
void BusStopList::setErrormessage(utility::string_t value)
{
	m_Errormessage = value;
    m_ErrormessageIsSet = true;
}
bool BusStopList::errormessageIsSet() const
{
    return m_ErrormessageIsSet;
}
void BusStopList::unsetErrormessage() 
{
    m_ErrormessageIsSet = false;
}
int32_t BusStopList::getNumberofresults() const
{
	return m_Numberofresults;
}
void BusStopList::setNumberofresults(int32_t value)
{
	m_Numberofresults = value;
    m_NumberofresultsIsSet = true;
}
bool BusStopList::numberofresultsIsSet() const
{
    return m_NumberofresultsIsSet;
}
void BusStopList::unsetNumberofresults() 
{
    m_NumberofresultsIsSet = false;
}
utility::string_t BusStopList::getTimestamp() const
{
	return m_Timestamp;
}
void BusStopList::setTimestamp(utility::string_t value)
{
	m_Timestamp = value;
    m_TimestampIsSet = true;
}
bool BusStopList::timestampIsSet() const
{
    return m_TimestampIsSet;
}
void BusStopList::unsetTimestamp() 
{
    m_TimestampIsSet = false;
}
std::vector<std::shared_ptr<Stop>>& BusStopList::getResults()
{
	return m_Results;
}
bool BusStopList::resultsIsSet() const
{
    return m_ResultsIsSet;
}
void BusStopList::unsetResults() 
{
    m_ResultsIsSet = false;
}
