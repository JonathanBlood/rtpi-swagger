...
void RouteList::validate() 
{
    // TODO: implement validation
}

web::json::value RouteList::toJson() const
{
...
void RouteList::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[U("results")].as_array() )
        {
            ...
            if(item.is_null()) 
            {
                m_Results.push_back( std::shared_ptr<Route>(nullptr) );
            }
            else
            {
                std::shared_ptr<Route> newItem(new Route());
...
void RouteList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void RouteList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
	if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
	{
...
utility::string_t RouteList::getErrorcode() const
{
	return m_Errorcode;
}
void RouteList::setErrorcode(utility::string_t value)
{
	m_Errorcode = value;
    m_ErrorcodeIsSet = true;
}
bool RouteList::errorcodeIsSet() const
{
    return m_ErrorcodeIsSet;
}
void RouteList::unsetErrorcode() 
{
    m_ErrorcodeIsSet = false;
}
utility::string_t RouteList::getErrormessage() const
{
	return m_Errormessage;
}
void RouteList::setErrormessage(utility::string_t value)
{
	m_Errormessage = value;
    m_ErrormessageIsSet = true;
}
bool RouteList::errormessageIsSet() const
{
    return m_ErrormessageIsSet;
}
void RouteList::unsetErrormessage() 
{
    m_ErrormessageIsSet = false;
}
int32_t RouteList::getNumberofresults() const
{
	return m_Numberofresults;
}
void RouteList::setNumberofresults(int32_t value)
{
	m_Numberofresults = value;
    m_NumberofresultsIsSet = true;
}
bool RouteList::numberofresultsIsSet() const
{
    return m_NumberofresultsIsSet;
}
void RouteList::unsetNumberofresults() 
{
    m_NumberofresultsIsSet = false;
}
utility::string_t RouteList::getTimestamp() const
{
	return m_Timestamp;
}
void RouteList::setTimestamp(utility::string_t value)
{
	m_Timestamp = value;
    m_TimestampIsSet = true;
}
bool RouteList::timestampIsSet() const
{
    return m_TimestampIsSet;
}
void RouteList::unsetTimestamp() 
{
    m_TimestampIsSet = false;
}
std::vector<std::shared_ptr<Route>>& RouteList::getResults()
{
	return m_Results;
}
bool RouteList::resultsIsSet() const
{
    return m_ResultsIsSet;
}
void RouteList::unsetResults() 
{
    m_ResultsIsSet = false;
}
