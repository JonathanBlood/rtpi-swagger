...
void RouteDetailList::validate() 
{
    // TODO: implement validation
}

web::json::value RouteDetailList::toJson() const
{
...
void RouteDetailList::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[U("results")].as_array() )
        {
            ...
            if(item.is_null()) 
            {
                m_Results.push_back( std::shared_ptr<RouteDetail>(nullptr) );
            }
            else
            {
                std::shared_ptr<RouteDetail> newItem(new RouteDetail());
...
void RouteDetailList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void RouteDetailList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
	if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
	{
...
utility::string_t RouteDetailList::getErrorcode() const
{
	return m_Errorcode;
}
void RouteDetailList::setErrorcode(utility::string_t value)
{
	m_Errorcode = value;
    m_ErrorcodeIsSet = true;
}
bool RouteDetailList::errorcodeIsSet() const
{
    return m_ErrorcodeIsSet;
}
void RouteDetailList::unsetErrorcode() 
{
    m_ErrorcodeIsSet = false;
}
utility::string_t RouteDetailList::getErrormessage() const
{
	return m_Errormessage;
}
void RouteDetailList::setErrormessage(utility::string_t value)
{
	m_Errormessage = value;
    m_ErrormessageIsSet = true;
}
bool RouteDetailList::errormessageIsSet() const
{
    return m_ErrormessageIsSet;
}
void RouteDetailList::unsetErrormessage() 
{
    m_ErrormessageIsSet = false;
}
int32_t RouteDetailList::getNumberofresults() const
{
	return m_Numberofresults;
}
void RouteDetailList::setNumberofresults(int32_t value)
{
	m_Numberofresults = value;
    m_NumberofresultsIsSet = true;
}
bool RouteDetailList::numberofresultsIsSet() const
{
    return m_NumberofresultsIsSet;
}
void RouteDetailList::unsetNumberofresults() 
{
    m_NumberofresultsIsSet = false;
}
utility::string_t RouteDetailList::getRoute() const
{
	return m_Route;
}
void RouteDetailList::setRoute(utility::string_t value)
{
	m_Route = value;
    m_RouteIsSet = true;
}
bool RouteDetailList::routeIsSet() const
{
    return m_RouteIsSet;
}
void RouteDetailList::unsetRoute() 
{
    m_RouteIsSet = false;
}
utility::string_t RouteDetailList::getTimestamp() const
{
	return m_Timestamp;
}
void RouteDetailList::setTimestamp(utility::string_t value)
{
	m_Timestamp = value;
    m_TimestampIsSet = true;
}
bool RouteDetailList::timestampIsSet() const
{
    return m_TimestampIsSet;
}
void RouteDetailList::unsetTimestamp() 
{
    m_TimestampIsSet = false;
}
std::vector<std::shared_ptr<RouteDetail>>& RouteDetailList::getResults()
{
	return m_Results;
}
bool RouteDetailList::resultsIsSet() const
{
    return m_ResultsIsSet;
}
void RouteDetailList::unsetResults() 
{
    m_ResultsIsSet = false;
}
