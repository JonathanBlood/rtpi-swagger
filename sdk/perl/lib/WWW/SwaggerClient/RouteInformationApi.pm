...
#
package WWW::SwaggerClient::RouteInformationApi;
...
# @param string $operator If provided retrieves routes for the given operator (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_routes' } = { 
...
sub get_routes {
    ...
    # parse inputs
    my $_resource_path = '/routelistinformation';
    ...
    my $_response_object = $self->{api_client}->deserialize('RouteList', $response);
