...
#
package WWW::SwaggerClient::RouteDetailInformationApi;
...
# @param string $format If not provided JSON format will be used by default (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_route_detail' } = { 
...
#
sub get_route_detail {
    my ($self, %args) = @_;

    # verify the required parameter 'operator' is set
    unless (exists $args{'operator'}) {
      croak("Missing the required parameter 'operator' when calling get_route_detail");
    }

    # verify the required parameter 'routeid' is set
    unless (exists $args{'routeid'}) {
      croak("Missing the required parameter 'routeid' when calling get_route_detail");
    }

    # parse inputs
    my $_resource_path = '/routeinformation';
    ...
    my $_response_object = $self->{api_client}->deserialize('RouteDetailList', $response);
