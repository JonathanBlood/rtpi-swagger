...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtpiRestWebServicesApi.BusStopList();
  });
  ...
  describe('BusStopList', function() {
    it('should create an instance of BusStopList', function() {
      // uncomment below and update the code to test BusStopList
      //var instane = new RtpiRestWebServicesApi.BusStopList();
      //expect(instance).to.be.a(RtpiRestWebServicesApi.BusStopList);
    });
