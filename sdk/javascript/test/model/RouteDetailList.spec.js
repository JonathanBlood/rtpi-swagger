...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtpiRestWebServicesApi.RouteDetailList();
  });
  ...
  describe('RouteDetailList', function() {
    it('should create an instance of RouteDetailList', function() {
      // uncomment below and update the code to test RouteDetailList
      //var instane = new RtpiRestWebServicesApi.RouteDetailList();
      //expect(instance).to.be.a(RtpiRestWebServicesApi.RouteDetailList);
    });
