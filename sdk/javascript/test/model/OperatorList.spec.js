...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtpiRestWebServicesApi.OperatorList();
  });
  ...
  describe('OperatorList', function() {
    it('should create an instance of OperatorList', function() {
      // uncomment below and update the code to test OperatorList
      //var instane = new RtpiRestWebServicesApi.OperatorList();
      //expect(instance).to.be.a(RtpiRestWebServicesApi.OperatorList);
    });
