...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtpiRestWebServicesApi.TimetableList();
  });
  ...
  describe('TimetableList', function() {
    it('should create an instance of TimetableList', function() {
      // uncomment below and update the code to test TimetableList
      //var instane = new RtpiRestWebServicesApi.TimetableList();
      //expect(instance).to.be.a(RtpiRestWebServicesApi.TimetableList);
    });
