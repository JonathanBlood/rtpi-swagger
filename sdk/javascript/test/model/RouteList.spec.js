...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtpiRestWebServicesApi.RouteList();
  });
  ...
  describe('RouteList', function() {
    it('should create an instance of RouteList', function() {
      // uncomment below and update the code to test RouteList
      //var instane = new RtpiRestWebServicesApi.RouteList();
      //expect(instance).to.be.a(RtpiRestWebServicesApi.RouteList);
    });
