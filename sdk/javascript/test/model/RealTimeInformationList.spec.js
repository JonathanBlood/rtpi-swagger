...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtpiRestWebServicesApi.RealTimeInformationList();
  });
  ...
  describe('RealTimeInformationList', function() {
    it('should create an instance of RealTimeInformationList', function() {
      // uncomment below and update the code to test RealTimeInformationList
      //var instane = new RtpiRestWebServicesApi.RealTimeInformationList();
      //expect(instance).to.be.a(RtpiRestWebServicesApi.RealTimeInformationList);
    });
