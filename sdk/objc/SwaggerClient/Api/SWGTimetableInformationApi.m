#import "SWGTimetableInformationApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGTimetableList.h"


@interface SWGTimetableInformationApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGTimetableInformationApi

NSString* kSWGTimetableInformationApiErrorDomain = @"SWGTimetableInformationApiErrorDomain";
NSInteger kSWGTimetableInformationApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGTimetableInformationApi *sharedAPI;
...
-(NSNumber*) getTimeTableWithType: (NSString*) type
    ...
    if (type == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGTimetableInformationApiErrorDomain code:kSWGTimetableInformationApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/timetableinformation"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGTimetableList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGTimetableList*)data, error);
                                }
                           }
          ];
}
