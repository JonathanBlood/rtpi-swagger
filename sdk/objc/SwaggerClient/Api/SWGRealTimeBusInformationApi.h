...
@interface SWGRealTimeBusInformationApi: NSObject <SWGApi>

extern NSString* kSWGRealTimeBusInformationApiErrorDomain;
extern NSInteger kSWGRealTimeBusInformationApiMissingParamErrorCode;
...
///
/// @return SWGRealTimeInformationList*
